...
const PlayList = ({ playerRef }: any) => {
    ...
    useEffect(() => {
        albumParam && axios.get(`${process.env.REACT_APP_ENV ? "http://localhost:4000" : "https://ahmadmarhaba-music-app-nodejs.herokuapp.com"}/api/playlist?id=${albumParam}`).then((response: any) => {
